 ...
 <BODY>
	...
	<table cellspacing="3" cellpadding="15" border="3" bordercolor="#006699">
		...
		<form METHOD=POST name="thisWeek" action="CaseClosureThisWeekServlet">
			<td width="500"><font color="#006699">Case Closure Rates This Week for Region&nbsp;</font>
			<select name="region">
		...
		<form METHOD=POST name="lastWeek" action="CaseClosureLastWeekServlet">
			<td width="500"><font color="#006699">Case Closure Rates Last Week for Region&nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
			</select>
			</td>
		...
		<form METHOD=POST name="showAll" action="CaseClosureShowAllServlet">
			<td width="500"><font color="#006699">Case Closure Rates for Region&nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
			</select>
			<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from <input id="popup_container" name="fromdate" type="text" /><font size="2"><i> &nbsp;(MM/DD/YYYY)</i></font><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to &nbsp;&nbsp;&nbsp;&nbsp;<input id="popup_container2" name="todate" type="text" /><font size="2"><i> &nbsp;(MM/DD/YYYY)</i></font><br>
		...
		<form METHOD=POST name="employeeDates" action="CaseClosureEmployeeDatesServlet">
			<td width="500"><font color="#006699">(UNDER CONSTRUCTION) Case Closure Rates for Employee &nbsp;</font>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from <input id="popup_container3" name="fromdate2" type="text" /><font size="2"><i> &nbsp;(MM/DD/YYYY)</i></font><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to &nbsp;&nbsp;&nbsp;&nbsp;<input id="popup_container4" name="todate2" type="text" /><font size="2"><i> &nbsp;(MM/DD/YYYY)</i></font><br>
