...
<HTML>
 ...
 <BODY>
	<h2><font color="#006699"> Training Reports</font></h2>
	
	<table cellspacing="3" cellpadding="15" border="3" bordercolor="#006699">
		<tr>
		<form METHOD=POST name="thisWeek" action="TrainingThisWeekServlet">
			<td width="500"><font color="#006699">All Training This Week for Region &nbsp;</font>
			<select name="region">
		...
		<tr>
		<form METHOD=POST name="thisWeek" action="TrainingLastWeekServlet">
			<td width="500"><font color="#006699">All Training Last Week for Region &nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
				<option value="APAC">APAC</option>
				<option value="EMEA">EMEA</option>
		...
		<tr>
		<form METHOD=POST name="showAll" action="TrainingShowAllServlet">
			<td width="500"><font color="#006699">All Training for Region&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
				<option value="APAC">APAC</option>
				<option value="EMEA">EMEA</option>
		...
		<tr>
		<form METHOD=POST name="employeeDates" action="TrainingEmployeeDatesServlet">
			<td width="500"><font color="#006699">All Training for Employee &nbsp;</font>
		...
		<tr>
		<form METHOD=POST name="teamDates" action="TrainingManagerDatesServlet">
			<td width="500"><font color="#006699">All Training for&nbsp;&nbsp;&nbsp;</font>
			<select name="manager">
