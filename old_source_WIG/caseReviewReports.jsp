...
<HTML>
 ...
 <BODY>
	<h2><font color="#006699"> Case Review Reports</font></h2>
	
	<table cellspacing="3" cellpadding="15" border="3" bordercolor="#006699">
		<tr>
		<form METHOD=POST name="thisWeek" action="CaseReviewsThisWeekServlet">
			<td width="500"><font color="#006699">All Case Reviews This Week for Region &nbsp;</font>
			<select name="region">
		...
		<tr>
		<form METHOD=POST name="thisWeek" action="CaseReviewsLastWeekServlet">
			<td width="500"><font color="#006699">All Case Reviews Last Week for Region &nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
				<option value="APAC">APAC</option>
				<option value="EMEA">EMEA</option>
		...
		<tr>
		<form METHOD=POST name="showAll" action="CaseReviewsShowAllServlet">
			<td width="500"><font color="#006699">All Case Reviews for Region&nbsp;</font>
			<select name="region">
				<option value="AMER">AMER</option>
				<option value="APAC">APAC</option>
				<option value="EMEA">EMEA</option>
		...
		<tr>
		<form METHOD=POST name="employeeDates" action="CaseReviewsEmployeeDatesServlet">
			<td width="500"><font color="#006699">(UNDER CONSTRUCTION) All Case Reviews for Employee &nbsp;</font>
		...
		<tr>
		<form METHOD=POST name="teamDates" action="CaseReviewsManagerDatesServlet">
			<td width="500"><font color="#006699">(UNDER CONSTRUCTION) All Case Reviews for&nbsp;&nbsp;&nbsp;</font>
			<select name="manager">
